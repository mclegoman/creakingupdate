...
public class OakCreakingHeartTreeDecorator extends TreeDecorator {
	public static final MapCodec<OakCreakingHeartTreeDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(OakCreakingHeartTreeDecorator::new, (treeDecorator) -> treeDecorator.probability);
	private final float probability;

	public OakCreakingHeartTreeDecorator(float probability) {
