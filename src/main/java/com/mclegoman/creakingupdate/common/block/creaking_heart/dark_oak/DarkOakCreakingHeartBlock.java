...
public class DarkOakCreakingHeartBlock extends CreakingVariantHeartBlock {
	public static final MapCodec<CreakingVariantHeartBlock> CODEC = createCodec(DarkOakCreakingHeartBlock::new);
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		if (world.isClient) {
			...
			return state.get(ACTIVE) ? validateTicker(type, BlockEntityRegistry.darkOakCreakingHeart, CreakingVariantHeartBlockEntity::tick) : null;
		}
	}
	public static TagKey<Block> getLogs() {
		return BlockTags.DARK_OAK_LOGS;
	}
}