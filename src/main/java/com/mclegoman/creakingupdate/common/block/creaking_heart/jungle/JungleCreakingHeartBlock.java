...
public class JungleCreakingHeartBlock extends CreakingVariantHeartBlock {
	public static final MapCodec<CreakingVariantHeartBlock> CODEC = createCodec(JungleCreakingHeartBlock::new);
	...
	public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
		return new JungleCreakingHeartBlockEntity(pos, state);
	}
	@Nullable
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		if (world.isClient) {
			...
			return state.get(ACTIVE) ? validateTicker(type, BlockEntityRegistry.jungleCreakingHeart, CreakingVariantHeartBlockEntity::tick) : null;
		}
	}
