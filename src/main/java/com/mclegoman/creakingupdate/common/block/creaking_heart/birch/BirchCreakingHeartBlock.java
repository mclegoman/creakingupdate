...
public class BirchCreakingHeartBlock extends CreakingVariantHeartBlock {
	public static final MapCodec<CreakingVariantHeartBlock> CODEC = createCodec(BirchCreakingHeartBlock::new);
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		if (world.isClient) {
			...
			return state.get(ACTIVE) ? validateTicker(type, BlockEntityRegistry.birchCreakingHeart, CreakingVariantHeartBlockEntity::tick) : null;
		}
	}
